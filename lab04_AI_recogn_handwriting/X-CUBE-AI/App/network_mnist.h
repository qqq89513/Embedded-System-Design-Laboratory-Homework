...
#ifndef __AI_NETWORK_MNIST_H__
#define __AI_NETWORK_MNIST_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_NETWORK_MNIST_MODEL_NAME          "network_mnist"

#define AI_NETWORK_MNIST_ACTIVATIONS_ALIGNMENT   (4)

#define AI_NETWORK_MNIST_IN_NUM       (1)
#define AI_NETWORK_MNIST_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 28, 28, 1, 1, NULL), \
}
#define AI_NETWORK_MNIST_IN_SIZE { \
  (28 * 28 * 1), \
}
#define AI_NETWORK_MNIST_IN_1_SIZE  (28 * 28 * 1)
#define AI_NETWORK_MNIST_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)





#define AI_NETWORK_MNIST_OUT_NUM      (1)
#define AI_NETWORK_MNIST_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 10, 1, NULL), \
}
#define AI_NETWORK_MNIST_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_NETWORK_MNIST_OUT_1_SIZE  (1 * 1 * 10)
#define AI_NETWORK_MNIST_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)

#define AI_NETWORK_MNIST_N_NODES (6)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_mnist
 ...
 * @ref ai_network_mnist_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_mnist_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_MNIST_*
 * defines into file @ref network_mnist.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_mnist_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_NETWORK_MNIST_H__*/
