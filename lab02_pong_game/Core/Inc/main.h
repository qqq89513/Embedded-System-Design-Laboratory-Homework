...
#define IO_USR_LED_Pin GPIO_PIN_1
#define IO_USR_LED_GPIO_Port GPIOI
...
#define IO_USR_BTN_Pin GPIO_PIN_11
#define IO_USR_BTN_GPIO_Port GPIOI
#define IO_USR_BTN_EXTI_IRQn EXTI15_10_IRQn
